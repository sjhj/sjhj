...
<div class="container">
	<div class="col-sm-12">
		<div class="col-sm-12">
			프로젝트명 <input type="text" name="Edt_Pno" readonly="readonly" placeholder="코드"/>
			<input type="text" name="Edt_Pname" readonly="readonly" id="dbl_popUp" placeholder="코드명"/>
